...
export const defaultExamples = {
  ...
  "company": "TechCorp Inc"
			...
			{
				input:
					"For support, reach out to Alex Chen (Technical Lead) at alex.chen@company.io or 888-999-0000",
				output: `{
  "name": "Alex Chen",
  ...
  "reason": "Login issue preventing work, time-sensitive situation"
			...
			{
				input:
					"Hi, I was wondering if you offer student discounts on your premium plan?",
				output: `{
  "category": "BILLING",
  "priority": "LOW",
  "reason": "General pricing inquiry, no immediate impact"
			...
			{
				input:
					"The API is returning 500 errors for all our production requests. Our service is down!",
				output: `{
  "category": "TECHNICAL",
  "priority": "URGENT",
